...
git push # Don't have to mention -u test-branch
```
...
## Change configurations on `yml` header

```{r include=TRUE, eval=FALSE}
open config.yaml
# Not sure what was done here. Do you remember TS?
...
stat <new file name> # I don't recall what this was for. 
